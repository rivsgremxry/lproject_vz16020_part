        ...
        <div class="collapse navbar-collapse pt-2 pl-5 pb-2" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="pr-4 pt-2 pb-2">
                    <div>
                        <select class="form-control" id="moduleSelect" name="moduleList">
                ...
                <li class="pr-4 pt-2 pb-2">
                    <div>
                        <select class="form-control" id="actorSelect" name="actorList">
            ...
            <div>
                <div class="form-check">
                    <?php while($row1 = mysqli_fetch_array($result1)):;?>
                        <div class="pt-4 ml-3">
                            <input class="form-check-input" type="checkbox" value="" id="<?php echo $row1[0];?>">
                            <label class="form-check-label mr-5 pr-4" for="<?php echo $row1[0];?>">
                                <?php echo $row1[1];?>
                            </label>
                        </div>
                    <?php endwhile;?>
